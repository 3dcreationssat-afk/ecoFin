...
The `screens/` PNG files are committed as synthetic Base44 preview references so future parity reviews can reproduce the audit context. They are not served by the application and should not be treated as implementation fixtures or personal financial evidence.
